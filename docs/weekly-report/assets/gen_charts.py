...
datasets/raw/give-me-some-credit/cs-training.csv; metric, feature importance và IV đọc từ artifact
...
CSV = ROOT / "datasets" / "raw" / "give-me-some-credit" / "cs-training.csv"
ART = ROOT / "outputs"
