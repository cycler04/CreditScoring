...
Đọc `.agents/workflows/04_write_research_report.md` và `.agents/03_conventions.md` trước.
...
4. Viết theo **Why → How**: chốt vấn đề/gap/hậu quả trước, rồi gắn từng lựa chọn
   modeling, training và benchmark với phần vấn đề mà nó xử lý.
5. Chỉ giữ chi tiết làm thay đổi kết luận hoặc giúp tái lập.
6. Tách rõ verified, inferred, unknown và planned.
7. Kiểm link/path/source và tránh lặp sự thật đã nằm ở file khác.
